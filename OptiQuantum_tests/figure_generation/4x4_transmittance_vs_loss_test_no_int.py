...
def main():
    ...
    transmittances = np.zeros([n_dB,5])
    ...
    for layer in mesh.layers:
        for mzi in layer:
            ...
            for i in range(n_dB):
                ...
                transmittances[i,n-1] = transmittance(mesh, mzi.m, mzi.n, mzi.m, mzi.n)
    ...
    plt.savefig(f'figures_set1/transmittance_vs_absolute_loss.png')

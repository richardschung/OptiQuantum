...
def main():
    ...
    visibs = np.loadtxt(f'figures_set1/visibiity_vs_random_phases_Clements_1000samples_MZI_1.txt')
    ...
    plt.savefig(f'figures_set1/Update October 26/visibility_vs_phase_sd_Clements_1000samples_MZI_1.png')

...
def main():
    ...
    plt.plot(lengths,coincs,label='Modeled HOM curve')
    plt.plot(quix[0],quix[1],'ro',label='Experimental data[13]')
    ...
    plt.savefig(f'figures_set1/Update November 19/HOM_vs_Quix_v5.eps')

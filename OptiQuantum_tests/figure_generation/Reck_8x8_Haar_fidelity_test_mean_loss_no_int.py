...
sys.path.append('../../')
from OptiQuantum.modified_neuroptica.layers_new import flipped_ReckLayer
from OptiQuantum.modified_neuroptica.component_layers_new import MZIDelayLayer, PhaseShifterLayer
from OptiQuantum.modified_neuroptica.components_new import MZI_delay
from OptiQuantum.modified_strawberry.decompositions_new_only import triangular_symmetric
...
def main():
    ...
    plt.savefig(f'figures_set1/Update November 6/Reck_8x8_fidelity_vs_random_loss_1000_samples_loss_diff_002.png')

    #Save Data
    np.savetxt(f'figures_set1/Update November 6/Reck_8x8_fidelity_vs_random_loss_1000_samples_loss_diff_002.txt',fidels)
    timer.toc()

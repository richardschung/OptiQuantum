    ...
    for layer in mesh.layers:
        for mzi in layer:
            ...
            for i in range(n_dB):
                ...
                fidels[i] = np.mean(fidel_samples)
                #print(fidels[i,j])
            ...
            plt.xlabel('Loss Uncertainty/MZI (dB)', fontsize=labels_size)
            ...
            plt.savefig(f'4x4_Clements/4x4_random_loss_Clements_fidelity_no_int_MZI_{n}.png')

...
def main():
            ...
            for sample in range(n_samples):
                for layer in mesh.layers:
                    for mzi in layer:
                        ...
                        mzi.phase_uncert_theta = thetas[i]
                        mzi.phase_uncert_phi = phis[j]
                        mzi.randomize_errors()
    ...
    plt.savefig(f'4x4_Clements/4x4_random_phase_Clements_MZI_1.png')

...
def main():
    ...
    for layer in mesh.layers:
        for mzi in layer:
            ...
            plt.pcolor(losses_dB, phases, fidels.T, cmap=cmap, rasterized=True, vmin=0, vmax=1)
            ...
            plt.savefig(f'4x4_Clements/4x4_random_error_Clements_fidelity_no_int_loss01_MZI_{n}.png')

...
def main():
    ...
    transmittances = np.zeros([n_dB,int(N*(N-1)/2)])
    ...
    plt.savefig(f'figures_set1/transmittance_vs_random_loss_Reck_1000_samples.png')

    #Save Data
    np.savetxt(f'figures_set1/transmittance_vs_random_phases_Reck_1000samples.txt',transmittances)

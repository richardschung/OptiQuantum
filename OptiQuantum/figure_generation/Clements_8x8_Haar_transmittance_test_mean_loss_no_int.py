...
##    out2 = N-1
                    ...
                    for mzi_cur in layer_cur:
                        if isinstance(mzi_cur,MZI_delay):
                            ...
                            if mzi_cur.loss_dB_cur < 0:
                                ...
                                print("gain detected")
                for n in range(N-1):
                    transmittance_samples[sample,n] = transmittance(mesh, n, n+1, out1, out2)
    ...
    plt.savefig(f'figures_set1/transmittance_1_2_vs_mean_loss_Clements_1000_samples_1Haar_loss_diff_002_new_loss.png')

    #Save Data
    np.savetxt(f'figures_set1/transmittance_1_2_vs_mean_loss_Clements_1000samples_1Haar_loss_diff_002_new_loss.txt',transmittances)
    timer.toc()

...
def main():
    ...
    for haar_num in range(n_Haars):
        ...
        network = flipped_ReckLayer(N, phases=phase_data, include_phase_shifter_layer=True,shifter_phases=localv,phase_uncert=np.pi/16)
        mesh = network.mesh
    ...
    plt.savefig(f'figures_set1/fidelity_vs_mean_phases_Reck_1000samples_5Haars_unc_pi_16.png')

    #Save Data
    np.savetxt(f'figures_set1/fidelity_vs_mean_phases_Reck_1000samples_5Haars_unc_pi_16.txt',fidels)

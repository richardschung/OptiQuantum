...
def main():
    ...
    for layer in mesh.layers:
        for mzi in layer:
            ...
            plt.savefig(f'figures_set1/visibility_vs_random_phases_Reck_1000samples_MZI_{n}.png')

            #Save Data
            np.savetxt(f'figures_set1/visibiity_vs_random_phases_Reck_1000samples_MZI_{n}.txt',visibs)

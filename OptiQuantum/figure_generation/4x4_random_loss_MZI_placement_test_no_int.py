...
def main():
    ...
    plt.plot(losses_dB,visibs.T[0],".-",label="MZI 1")
    plt.plot(losses_dB,visibs.T[1],"s-",label="MZI 2")
    plt.plot(losses_dB,visibs.T[2],"o-",label="MZI 3")
    plt.plot(losses_dB,visibs.T[3],"^-",label="MZI 4")
    plt.plot(losses_dB,visibs.T[4],"v-",label="MZI 5")
    ...
    plt.ylabel(r'Visibility', fontsize=labels_size)
    ax.legend()
    #cbar = plt.colorbar()
    ...
    plt.savefig(f'figures_set1/visibility_vs_random_loss_1000samples_big.png')
    #plt.show()
